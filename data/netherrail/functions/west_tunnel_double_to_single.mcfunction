...
fill ~-8 ~ ~-3 ~-8 ~ ~-2 minecraft:stone_brick_stairs[facing=south, half=bottom]
fill ~-8 ~ ~ ~-8 ~ ~1 minecraft:stone_brick_stairs[facing=south, half=bottom]
fill ~-8 ~2 ~-3 ~-8 ~2 ~-2 minecraft:stone_brick_stairs[facing=south, half=top]
fill ~-8 ~2 ~ ~-8 ~2 ~1 minecraft:stone_brick_stairs[facing=south, half=top]
