        ...
        if self.fromDirection == "east":
            for element in self.lineEnd:
                if "facing=south" in element:
                    ...
                    self.lineEnd_north.append(element.replace("facing=west", "facing=south"))
                    self.lineEnd_south.append(element.replace("facing=west", "facing=north"))
                    self.lineEnd_east.append(element)
                    self.lineEnd_west.append(element.replace("facing=west", "facing=east"))
                elif "facing=east" in element:
                    self.lineEnd_north.append(element.replace("facing=east", "facing=north"))
                    self.lineEnd_south.append(element.replace("facing=east", "facing=south"))
                    self.lineEnd_east.append(element)
                    self.lineEnd_west.append(element.replace("facing=east", "facing=west"))
                else:
