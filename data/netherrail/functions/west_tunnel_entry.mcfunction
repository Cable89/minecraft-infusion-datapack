fill ~-1 ~-2 ~-2 ~2 ~-2 ~2 minecraft:stone_bricks
fill ~-2 ~-1 ~-1 ~-5 ~-1 ~1 minecraft:stone_bricks

fill ~2 ~ ~-1 ~-5 ~2 ~1 minecraft:air
...
setblock ~-1 ~2 ~-2 minecraft:stone_brick_stairs[facing=west, half=top]
setblock ~-1 ~2 ~2 minecraft:stone_brick_stairs[facing=west, half=top]
setblock ~-1 ~ ~-2 minecraft:stone_brick_stairs[facing=west, half=bottom]
setblock ~-1 ~ ~2 minecraft:stone_brick_stairs[facing=west, half=bottom]

setblock ~-1 ~2 ~-1 minecraft:stone_brick_stairs[facing=west, half=top, shape=outer_right]
setblock ~-1 ~2 ~1 minecraft:stone_brick_stairs[facing=west, half=top, shape=outer_left]
setblock ~-1 ~ ~-1 minecraft:stone_brick_stairs[facing=west, half=bottom, shape=outer_right]
setblock ~-1 ~ ~1 minecraft:stone_brick_stairs[facing=west, half=bottom, shape=outer_left]
