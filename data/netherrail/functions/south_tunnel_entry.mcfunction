...
setblock ~-2 ~2 ~1 minecraft:stone_brick_stairs[facing=south, half=top]
setblock ~2 ~2 ~1 minecraft:stone_brick_stairs[facing=south, half=top]
setblock ~-2 ~ ~1 minecraft:stone_brick_stairs[facing=south, half=bottom]
setblock ~2 ~ ~1 minecraft:stone_brick_stairs[facing=south, half=bottom]

setblock ~-1 ~2 ~1 minecraft:stone_brick_stairs[facing=south, half=top, shape=outer_right]
setblock ~1 ~2 ~1 minecraft:stone_brick_stairs[facing=south, half=top, shape=outer_left]
setblock ~-1 ~ ~1 minecraft:stone_brick_stairs[facing=south, half=bottom, shape=outer_right]
setblock ~1 ~ ~1 minecraft:stone_brick_stairs[facing=south, half=bottom, shape=outer_left]
