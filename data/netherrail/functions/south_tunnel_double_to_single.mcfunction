...
fill ~-3 ~ ~8 ~-2 ~ ~8 minecraft:stone_brick_stairs[facing=east, half=bottom]
fill ~ ~ ~8 ~1 ~ ~8 minecraft:stone_brick_stairs[facing=east, half=bottom]
fill ~-3 ~2 ~8 ~-2 ~2 ~8 minecraft:stone_brick_stairs[facing=east, half=top]
fill ~ ~2 ~8 ~1 ~2 ~8 minecraft:stone_brick_stairs[facing=east, half=top]
